...
<div style="box-shadow: 5px 5px 5px 5px  #ccccff; margin-left:400px ;margin-top:150px;background-color: #f3f3f3 ;width:300px;">
    ...
    <form method="Post" action="Managerforgotpwd.php">
        ...
        <input class="btn " type="Submit" style="background-color: #0056b3;margin-left: 60px;" name="forgotpwd" value ="Send-Code">


    </form>
    <br>
    <a href="ManagerLoginpage.php" style="color: #0056b3;margin-left: 80px;"><i>Login</i></a>
    <br><br>
</div>
