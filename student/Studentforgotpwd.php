...
class ForgotPass extends Db_Connect{
    ...
    public function resetPassword(){
        ...
        if($validate->validatemail($this->email)==true){
            ...
            echo "<script>window.open('Studentforgotpwdpage.php','_self')</script>";
            exit();
        }else
        {
        ...
        <a href='http://127.0.0.1/Estates-System/student/StudentResetpwd.php'>Click here </a> and reset. Dont Reply'"    ;
            ...
            $getEmail = "SELECT email From PROJECT.student  WHERE email = ?";
            ...
            if($rungetEmail->rowCount()<1){
                ...
                $updateToken = "UPDATE PROJECT.student  SET token=?, tokenexpire=DATE_ADD(NOW(), INTERVAL 5 MINUTE ) WHERE email=?";
